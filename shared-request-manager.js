...
class SharedRequestManager {
     ...
     */
    startQueueProcessor() {
        this._queueIntervalId = setInterval(() => {
    ...
    /**
     * PERF-004: Stop the queue processor interval and clear singleton reference.
     * Call when the module is unloaded to prevent the interval from leaking.
     */
    destroy() {
        ...
        SharedRequestManager.instance = null;
        this.log('SharedRequestManager destroyed');
    }
}
